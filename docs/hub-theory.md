...
| Rewards & payments | Signed Nostr economy events | WeixBucks / BKSP |
...
| **BKSP** | BLKSPACE COIN (counsel-gated) | Optional withdrawal of **earned** WB only | On-chain receipt; not daily earn or speculation |
...
| Contribution | WeixBucks/hour (simulated) | BKSP settlement (Phase 4) |
|--------------|---------------------------|-----------------|
...
2. **Settled payments** — WeixBucks/BKSP flows with transparent history
...
**Phase 4:** Solana BKSP settlement + NFT ticketing.
...
| Tokens | WeixBucks + BKSP two-tier |
