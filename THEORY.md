...
- **Simulated economy first**: Signed Nostr events + SQLite — verifiable, migratable to on-chain BlkCoin (Phase 4)
- **Two-tier rewards**: WeixBucks (everyday) + BlkCoin (premium meme-coin)
...
| **4** | Solana BlkCoin, NFT tickets, marketplace | Planned |
...
- Simulated economy → Solana BlkCoin in Phase 4
- WeixBucks + BlkCoin two-tier
