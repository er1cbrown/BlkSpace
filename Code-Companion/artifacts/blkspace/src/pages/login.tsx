...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Login failed — check your key and handle");
    } finally {
      setSaving(false);
    }
  };
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-lg border-primary/10">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-base">Sign in with your Nostr secret key</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <Button onClick={handleLogin} className="w-full rounded-full h-12 text-base font-bold" disabled={saving || !nsec.trim() || !handle.trim()}>
