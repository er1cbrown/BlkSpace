    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 container py-12 px-4 max-w-5xl">
        {isLoading ? (
                ...
                {Array.isArray(arch.layers) &&
                  arch.layers.map((layer, i) => (
                    ...
                    >
                      ...
                      <Card
                        className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] shadow-md border-t-4 transition-transform hover:-translate-y-1"
                        style={{
                          borderTopColor: layer.color || "var(--primary)",
                        }}
                      >
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm whitespace-nowrap">
                  ...
                  <tbody className="divide-y">
                    {Array.isArray(arch.securityLayers) &&
                      arch.securityLayers.map((sec, i) => (
                        <tr
                          key={i}
          ...
          <div className="text-center py-20 text-muted-foreground border rounded-2xl border-dashed">
