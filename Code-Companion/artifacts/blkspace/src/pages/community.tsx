...
function resolveCommunityFromCatalog(rawId: string): CommunityView | null {
  ...
  if (!hbcu) {
    ...
    hbcu =
      hits.find((h) => h.id === id || h.shortName.toLowerCase().includes(id)) ??
      hits[0] ??
      null;
  }
  if (!hbcu) return null;
...
export default function CommunityPage() {
  ...
  return (
    <AppShell fullWidth hideRightRail>
      ...
      {yardTheme && (
        <YardCommunitySkin theme={yardTheme} communityName={community.name} />
      )}
        ...
        <div className="lg:col-span-9">
          ...
          >
            ...
            <TabsContent value="live">
              <YardLiveRooms yardId={yardId} communityName={community.name} />
            </TabsContent>
                ...
                <CardContent className="p-6 space-y-4 text-sm">
                  ...
                  {yardTheme && (
                    <div className="space-y-2 pt-2">
                      ...
                      <div>
                        <strong>Campus vibe:</strong>{" "}
                        {yardTheme.norms.join(" · ")}
                      </div>
                      <div>
