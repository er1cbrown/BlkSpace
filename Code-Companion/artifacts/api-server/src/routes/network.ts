  ...
  res.json({
    ...
    principles: [
      ...
      },
      {
        ...
        description: "Incentives (WeixBucks and BlkCoin) are first-class architectural concerns. The design actively mitigates reward farming, Sybil attacks, and collusion.",
      },
    ],
    securityLayers: [
      {
