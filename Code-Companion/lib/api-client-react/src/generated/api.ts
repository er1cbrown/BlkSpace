...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUser>>> = ({
    signal,
  }) => getUser(handle, { signal, ...requestOptions });
...
export const getGetUserPostsQueryKey = (handle: string) => {
  return [`/api/users/${handle}/posts`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserPosts>>> = ({
    signal,
  }) => getUserPosts(handle, { signal, ...requestOptions });
...
export const getListRelaysQueryKey = () => {
  return [`/api/relays`] as const;
};

export const getListRelaysQueryOptions = <
  TData = Awaited<ReturnType<typeof listRelays>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listRelays>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listRelays>>> = ({
    signal,
  }) => listRelays({ signal, ...requestOptions });
...
export type ListRelaysQueryResult = NonNullable<
  Awaited<ReturnType<typeof listRelays>>
>;
...
export const getGetRelayQueryKey = (id: number) => {
  return [`/api/relays/${id}`] as const;
};

export const getGetRelayQueryOptions = <
  TData = Awaited<ReturnType<typeof getRelay>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getRelay>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getRelay>>> = ({
    signal,
  }) => getRelay(id, { signal, ...requestOptions });
  ...
  return {
    ...
    enabled: !!id,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getRelay>>, TError, TData> & {
    queryKey: QueryKey;
  };
};

export type GetRelayQueryResult = NonNullable<
  Awaited<ReturnType<typeof getRelay>>
>;
...
export const getGetRecentActivityQueryKey = () => {
  return [`/api/network/activity`] as const;
};
...
export const getGetArchitectureQueryKey = () => {
  return [`/api/network/architecture`] as const;
};
